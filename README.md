...
This specific version of Kine is unique because it handles filtering directly at the database level, which can make your cluster much faster and more efficient.
...
- Step C: Before you create your custom resource, you have to ensure Kubernetes Controller Manager avoids caching all the instances. Best if you create a `MutatingAdmissionPolicy`
